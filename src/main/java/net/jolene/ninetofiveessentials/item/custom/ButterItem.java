...
public class ButterItem extends Item {
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity player, LivingEntity entity, Hand hand) {
        ...
        if (!world.isClient && wolf.isTamed()) {
            wolf.heal(1.0F);
            ...
            if (world instanceof ServerWorld serverWorld) {
                ItemStack butterStack = new ItemStack(this);
                ItemStackParticleEffect butterParticles = new ItemStackParticleEffect(ParticleTypes.ITEM, butterStack);
                for (int i = 0; i < 8; i++) {
