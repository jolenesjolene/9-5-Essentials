...
public class ModFoodComponents {
    ...
    public static final FoodComponent WINE = (new FoodComponent.Builder()).nutrition(6).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent WHISKEY = (new FoodComponent.Builder()).nutrition(6).saturationModifier(0.1F).alwaysEdible().build();
