...
public class ModFoodComponents {
    ...
    public static final FoodComponent TIRAMISU = new FoodComponent.Builder().nutrition(18).saturationModifier(0.6F).build();
    ...
    public static final FoodComponent CROISSANT = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
    public static final FoodComponent BUTTER = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
    public static final FoodComponent CHOCOLATE = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
    ...
    public static final FoodComponent LIQUORICE_SWEET = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
